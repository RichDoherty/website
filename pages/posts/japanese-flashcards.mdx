...
import jpFlashcards from '../../public/images/japanese-flashcards/japanese-flashcards.png'
import toolbar from '../../public/images/japanese-flashcards/toolbar.png'
...
<Image
    ...
    className='rounded-lg w-4/5 lg:w-1/2 h-auto mx-auto'
/>
