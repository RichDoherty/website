...
import pokedexImg from '../../public/images/poke-api/pokédex.png'
import consoleLog from '../../public/images/poke-api/consolelog.png'
import pokedexProgress from '../../public/images/poke-api/pokedexProgress1.png'
import bulbasaur from '../../public/images/poke-api/bulbasaur.png'
        ...
        <div>
          ...
          <div>
            ...
            {pokemon.types.map((slot: any, index: number) => (
              <p key={slot.type.name}><span className={`${slot.type.name}`}>{slot.type.name}</span></p>
            ))}
          </div>
        </div>
      </main>
